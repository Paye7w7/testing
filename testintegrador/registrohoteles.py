...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Pruebas automatizadas para Registro de Hotel</p>
        </div>
...
def generar_pdf(texto_resultados, capturas, archivo_salida, duracion, fecha_hora):
    ...
    pdf.cell(0, 10, "Reporte de Smoke Test - Registro Hotel", ln=True, align="C")
    pdf.ln(10)
...
def smoke_test():
    ...
    resultados = []
    capturas = []
    url = "http://localhost:3000/php/registro_hotel.php"
    ...
    # Enviar correo
    asunto = "Reporte Smoke Test - Registro de Hotel"
    cuerpo = "Este es el testeo de registro de hotel. Adjuntamos el reporte con capturas."
