...
from utils.report_hoteles import generar_pdf
from utils.gmail import enviar_correo

def smoke_test_hotel():
    ...
    asunto = "Reporte de Smoke Test - Creación de Hoteles"
    cuerpo = f"""
    Este es el testeo de creación de Hoteles.
