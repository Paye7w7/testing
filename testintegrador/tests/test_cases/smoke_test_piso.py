...
from utils.report_piso import generar_pdf
...
def smoke_test_piso():
    ...
    resultados = []
    capturas = []
    url = "http://localhost:3000/admin/piso/pisos_habitaciones.php?action=create"
    ...
    asunto = "Reporte de Smoke Test - crear Registro de piso nuevo"
    cuerpo = f"""
    Este es el testeo de creación de crear Registro de piso nuevo.
