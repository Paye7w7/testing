...
from utils.report_servicio import generar_pdf
from utils.gmail import enviar_correo

def smoke_test_servicio():
    ...
    resultados = []
    capturas = []
    url = "http://localhost:3000/admin/servicio/servicios.php?action=create"
    ...
    try:
        ...
        campos = {
            ...
            "Precio": "precio",
            "Duración del servicio": "duracion",
            "Tipo de servicio": "tipo_servicio_id",
        }
    ...
    asunto = "Reporte de Smoke Test - Creación de Servicio"
    cuerpo = f"""
