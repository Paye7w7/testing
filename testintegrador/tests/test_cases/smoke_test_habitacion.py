...
from utils.report_habitacion import generar_pdf
from utils.gmail import enviar_correo

def smoke_test_habitacion():
    ...
    asunto = "Reporte de Smoke Test - Creación de Habitaciones"
    cuerpo = f"""
    Este es el testeo de creación de habitación.
