...
from utils.report_huesped import generar_pdf
from utils.gmail import enviar_correo

def smoke_test_huesped():
    ...
    asunto = "Reporte de Smoke Test - Creación de Usuario Huesped"
    cuerpo = f"""
    Este es el testeo de creación de Usuarios(Huesped).
